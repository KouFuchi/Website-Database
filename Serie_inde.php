...
<body>
    ...
    <?php
      ...
      if (empty($_GET)){
       ...
       show($conn);
        ...
        show($conn);
          ...
          $sql = "Insert into Series values($SeriesID, '$Seriesname')";
      ...
      function show($conn){
        ...
        echo "<center>";
        echo "編號<input type=text name=SeriesID >&nbsp;&nbsp;";
        echo "書系<input type=text name=Seriesname >&nbsp;&nbsp;";
        ...
        while ($row != NULL){
          ...
          echo "<td><a href=Serie_inde.php?SeriesID=$SeriesID>刪除</a></td>";
          echo "</tr>";
          $row = mysqli_fetch_row($result); 
        }
       }
