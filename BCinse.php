...
<body>
     ...
     <br><br><br><br>
     <center><h3>合併查詢Books和Chapters資料表</h3></center><br>
     <form action="" method="post" align="center" >
      ...
      <select name="option">
        ...
        <option value="Chapters.Chapterauthor">作者</option>
        <option value="Chapters.Chaptername">章節名</option>
    ...
    */
     ...
     if(isset($_POST['submit'])){
      $link = @mysqli_connect('localhost', '107dba09', '107dba09', '107dba09');
        ...
        $sql='SELECT Books.*, Included.*, Chapters.*
    FROM Books INNER JOIN (Chapters INNER JOIN Included ON Chapters.ChapterID = Included.ChapterID) ON Books.BookID = Included.BookID WHERE '.$option.' like "%'.$key.'%"' ;
