...
<body>
     ...
     <br><br><br><br>
     <center><h3>合併查詢Books和Author資料表</h3></center><br>
     <form action="" method="post" align="center" >
      ...
      <select name="option">
        ...
        <option value="Author.Authorname">作者</option>
        <option value="Author.Field">領域</option>
        <option value="Author.Organization">機構</option>         
      </select> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    */
     ...
     if(isset($_POST['submit'])){
      $link = @mysqli_connect('localhost', '107dba09', '107dba09', '107dba09');
        ...
        $sql='SELECT Books.*, Wrote.*, Author.* FROM Books INNER JOIN (Author INNER JOIN Wrote ON Author.AuthorID = Wrote.AuthorID) ON Books.BookID = Wrote.BookID WHERE '.$option.' like "%'.$key.'%"' ;
